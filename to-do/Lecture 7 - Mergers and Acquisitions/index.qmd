...
-   See [Finance Reading: The Mergers and Acquisitions Process]{.blue} for a thorough discussion around the M&A process
-   See [Evaluating M&A Deals: Introduction to the Deal NPV]{.blue} for a detailed discussion on how to use the valuation methods from previous lectures to assess the value of an M&A deal
