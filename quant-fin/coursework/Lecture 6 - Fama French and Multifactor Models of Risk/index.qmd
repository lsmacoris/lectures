...
ff_data=readRDS('Assets/ff_data.rds')
...
#Fama-French
ff_em_url <- "https://mba.tuck.dartmouth.edu/pages/faculty/ken.french/ftp/Developed_3_Factors_CSV.zip"

# Download and unzip
temp <- tempfile()
download.file(ff_em_url, temp)
unzip(temp, exdir = tempdir())

# Locate the CSV file and read it
ff_file <- list.files(tempdir(), pattern = "Developed_3_Factors", full.names = TRUE)
ff_data <- read_csv(ff_em_file, skip = 3)%>%
