...
In the official webpage of this course, I have outlined all necessary steps to get started using *R*, as well as some useful tips for those that want to get up to speed on the course's requirements - pleass follow [this](https://lsmacoris.github.io/lectures/quant-fin.html) link and carefully read the instructions.
:::
