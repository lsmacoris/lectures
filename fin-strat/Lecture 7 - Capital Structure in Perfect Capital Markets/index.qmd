...
-   The [Capital Structure]{.blue} decision of a firm is the relative proportion of debt, equity, and other securities that a firm has outstanding constitute its capital

-   A central question in this chapter: **do capital structure decisions affect firm value?**

. . .

$\rightarrow$ *To facilitate the discussion, throughout the chapter, we will assume the firm is a portfolio of debt and equity (and maybe other securities)*
...
-   Therefore, the value of the firm is $\small \$1,000$. If you take the initial investment into consideration, the NPV for the investors is $\small PV(CF) = -800 + 1,000=200$. We'll now look at different scenarios that will vary on which specific [Capital Structure]{.blue} will be used to finance the project!

## Case 1: all-Equity financing

-   Say that you decide to fund this project using 100% equity in your Capital Structure

-   The firm value today is $\small\$1,000$. If the firm wants to finance the project all-equity, it could raise this amount selling equity to outside investors. In this case, the firm is called *unlevered equity*

-   From the perspective of an equity investor:
...
$\rightarrow$ *Because the risk of unlevered equity equals the risk of the project, shareholders are earning an appropriate return for the risk they are taking*
...
-   To see that in action, assume that the firm issues $\small \$500$ of debt and $\small\$500$ of equity, with the cost of debt being $\small 5\%$. A central question in this discussion is: [do the NPV and the firm value change?]{.blue}

-   The short answers is: **no, the firm value will not change!**

    1.  As we'll see in the upcoming slides, although the cost of debt is *lower* than the cost of equity ($5\%$ \*versus $15\%$), the fact that we introduced debt in the firm's capital structure makes equity riskier
...
-   Let's get back to our example where we added $50\%$ of debt in our Capital Structure. Because the firm needs to pay debt holders no matter the state of the economy, the Debt value (from the perspective of a debt investor) in Date 1 is:
...
-   From our previous slides, we know the value of the firm (all Assets) in each state of the economy. We can say that the difference between the firm value and the debt value is the equity value: $\small V - D = E$:
...
-   You may have noticed something strage: if the debt cost is only 5%, [why the firm value still is 1.000]{.blue}? Shouldn't the value of equity increase? The answer is that **the cost of equity increases for levered equity**:
...
1.  [Unlevered Equity]{.blue} has returns of $\small40\%$ or $\small-10\%$ $\rightarrow$ On average, $\small15\%$
...
-   Using the same values as before, suppose the firm borrows [\$700]{.blue} when financing the project. According to Modigliani and Miller, what should the value of the equity be? What is the expected return?

-   Because the value of the firm's total cash flows is still [\$1,000]{.blue}, if the firm borrows [\$700]{.blue}, its equity will be worth [\$300]{.blue}. The firm will owe $\small 700 \times 1.05 = 735$ in one year to debtholders:

    1.  If the economy is [strong]{.green}, equity holders will receive $\small 1,400 − 735 = 665$, for a return of $\small \frac{665}{300}-1 = \small 121.67\%$.
    2.  If the economy is [weak]{.red}, equity holders will receive $\small 900 − 735 = 165$, for a return of $\small \frac{165}{300}-1 = \small -45\%$.
...
-   *Modigliani and Miller* demonstrated that if investors would prefer an alternative capital structure to the one the firm has chosen, investors can borrow or lend on their own and [achieve the same result]{.blue} in terms of firm value!
...
-   To illustrate that, assume the firm is an [all−equity firm]{.blue} (zero leverage)...
  ...
  3. The investor borrows 500 and buys the firm's stock.
...
- Now, assume the firm uses debt, but the investor would prefer to hold unlevered equity
  ...
  2. Combining the cash flows of the two securities produces cash flows identical to Unlevered Equity, for a total cost of \$1000:
...
- All in all, [isn’t debt a cheaper and better source of capital than equity]{.blue}? Although debt does have a lower cost of capital than equity, we cannot consider this cost in isolation:
  ...
  2. In the end, the savings a [lower]{.green}  debt cost of capital are *exactly offset* by a [higher]{.red} equity cost of capital, and there are no net savings for
the firm!
...
- Rearranging terms and solving for $r_E$:
...
$$
\small r_{WACC} = \frac{E}{E+D} \times r_E + \frac{D}{E+D} \times r_D
$$
