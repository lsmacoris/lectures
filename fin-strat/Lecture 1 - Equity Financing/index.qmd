...
[Equity Financing]{.blue} is the money that helps firms to grow through equity participation (*i.e*, acquiring a share of the company). Although the [initial capital]{.blue} that is required to start a business is usually provided by the entrepreneur, Equity Financing is a source of funding that can come from external investors
:::
...
-   Angel investors often circumvent this problem by holding either a convertible note or a *SAFE* (*simple agreement for future equity*) rather than equity:
    1.  Usually, angel investors have a [share price discount]{.blue} over new investors due to higher uncertainty
    2.  Structuring the deal in this way allows **angels and entrepreneurs to agree on terms without agreeing on a value for the firm**, instead postponing the valuation decision until the firm is more mature and attractive to venture capitalists
...
A limited partnership that specializes in raising money to invest in the private equity of [young]{.blue} firms. One of the general partners who work for and run a venture capital firm.
:::
...
-   Venture Capital firms offer limited partners advantages over investing directly in start-ups themselves as angel investors:
    ...
    4.  Usually, they demand greater control over the company's ownership (*e.g.*, board seats): there is evidence that monitoring these firms pay off [@Bernstein]
...
- Private equity firms share the advantages of venture capital firms, and also charge similar fees. One key difference between private equity and venture capital is the magnitude invested:
...
- You gained knowledge on the main players of the equity-financing market. What happens next?
...
- Each of these issuances are called *founds*, as we'll see in the next slide 
...
1.  *Liquidation Preference*: The liquidation preference specifies a minimum amount that must be paid to these security holders---before any payments to common stockholders---in the event of a liquidation, sale, or merger of the company. It is typically set to between 1 and 3 times the value of the initial investment.

2.  *Seniority*: It is not uncommon for investors in later rounds to demand seniority over investors in earlier rounds, to ensure that they are repaid first. When later round investors accept securities with equal priority, they are said to be pari passu.
...
4.  *Exit Strategy*: It details how investors will eventually realize the return from their investment
...
The process of selling stock to the public [for the first time]{.blue}
:::
...
-   In what follows, we'll review some important characteristics of the IPO process
...
-   *RAX House*'s book value of equity is $\small 585 - 415 = 170 million$. With 118 million shares outstanding, book value per share is $\frac{170}{118} = \small 1.44$ per share. Given the industry average of 2.3, the estimated IPO price would be $\small 1.44 \times 2.3 = \small \$3.31$
...
-   Research has found that about 75% of first-day returns are [positive]{.green}: the average first-day return in the United States is 17%
...
1.  The pre-IPO shareholders bear the cost of underpricing
2.  In effect, these owners are selling stock in their firm for less than they could get in the aftermarket.
...
$\rightarrow$ *The typical investor will have their investment in [good]{.green} IPOs rationed while fully investing in [bad]{.red} IPOs!*
...
-   A typical spread is roughly [7%]{.blue} of the issue price

-   By most standards, this fee is large, especially considering the additional cost to the firm associated with underpricing (that is borne out by the shareholders of the firm prior to the IPO)
...
-   The main difference is that a market price for the stock [already exists]{.blue}, so the price-setting process is *not* necessary: share issuance price is determined by
...
-   Researchers have found that, on average, the market greets the news of an SEO with a price decline. This is consistent with an *Adverse Selection* argument - *i.e,*
