...
-   Let's go back to our previous example on *Armin*. How do bankruptcy costs fit into that situation?
    ...
    2.  However, we have assumed that there weren't any financial distress costs!
...
-   As the value of the levered equity is $\small \$23.81$ million, the share price is now only $\$10$ per share. All in all, all shareholders[^1] are worse off by:
...
-   *Baxter*'s manager is considering a new strategy that requires no upfront investment, but it has only a [$\small50\%$]{.blue} chance of success:
...
-   [Why managers would even consider this strategy?]{.blue} It is important to note that, [if Baxter does nothing]{.blue}, it will ultimately *default* and equity holders will get nothing with certainty:
    ...
    3.  Given a $\small50\%$ chance of success, the [equityholders]{.blue}' expected payoff is [positive]{.green}:
...
-   Note that, in such a way, equityholders are *gambling* with the debt holders' money:
    1.  If project [succeeds]{.green}, debtholders receive $\small \$1$ million
    2.  If [fails]{.red}, deb holders receive $\small\$300,000$
...
1.  Shareholders have an incentive to invest in negative-NPV projects that are risky, even though a negative-NPV project destroys value for the firm overall, but can bail-out shareholders in case of success
2.  Anticipating this bad behavior, security holders will pay less for the firm *ex-ante*
...
-   What if there are actually projects less risky projects that would otherwise [increase]{.green} the firm's NPV?
...
## Scenes from *Succession*

{{< video https://www.youtube.com/watch?v=sMt9s4XkY9Y width="1200" height="600" >}}


$\rightarrow$ *See "Succession" on IMBd - access [here](https://www.imdb.com/title/tt7660850/)*
...
-   Entrenchment may allow managers to run the firm in their *own* best interests:
    ...
    2.  Spending on perks, like private jets, and sponsoring their *"pet-projects"*
...
-   To see that, assume that you are the owner of a firm and plans to expand. You can either borrow the funds needed for expansion or raise the money by selling shares in the firm:
    ...
    1.  If issuing [equity]{.blue}, you will need to sell $\small40\%$ of the firm to raise the necessary funds
    2.  If issuing [debt]{.blue}, you retain full ownership of the firm
...
1.  Is likely that you work harder as you will receive the totality of the increase in firm value
2.  Since you bear the totality of the perks' costs, you would less tempted to overspend
...
-   Estimating the *net* effect of Agency Costs and Benefits is an empirical matter, and despite that fact that we do not know with certainty what the value is, it is rational to assume that firms would pursue an *optimal* debt level by taking into account *both* agency [costs]{.red} and [benefits]{.green}:
...
-   In other words:
    1.  If the firm is issuing equity at market prices, it must be that managers think the stock is [expensive]{.red}
    2.  If the firm is buying back shares at market prices, it must be that managers think the stock is [cheap]{.green}
...
- This helps explaining why *startups* tend to rely more on internal funding before going through an external funding process:
  1. It is very difficult to assess the expected cash-flows from these firms
  2. As a consequence, they would be heavily discounted when issuing securities to external investors that do not know the company's prospects
