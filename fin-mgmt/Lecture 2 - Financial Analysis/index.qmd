...
2. **Important**: whenever assessing which accounts should be classified as *debt*, one might need to adjust the calculations to include other items that are also interest bearing, such as leases^[See *IFRS 16* note on leases [here](https://www.ifrs.org/issued-standards/list-of-standards/ifrs-16-leases/)]
