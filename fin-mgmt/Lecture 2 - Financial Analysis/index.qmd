...
labs(title='How different Leverage choices affect ROE?',
...
-   Our *ROE* decomposition yielded the following results:
    ...
    1.  The Return on Assets is $\small20\%$
    2.  Firm's leverage is $\small1.5$
...
- **Note, however, that there is a catch:** if the firm's *ROA* is [negative]{.red}, it means that the shareholder's *ROE* will be even [lower]{.red} than in the case where the company was financed using 100% Equity!
