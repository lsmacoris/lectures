...
-   With that, for each period, we calculate the cumulative sum of the cash-flows:
    ...
    1.  **Year 1**: $\small -219,600+46,592 =$ [-173,008]{.red}
    2.  **Year 2**: $\small -173,008+69,266 =$ [-103,742]{.red}
    3.  **Year 3**: $\small -103,742+80,218 =$ [-23,524]{.red}
    4.  **Year 4**: $\small -23,524+101,293 =$ [+77,769]{.green}
...
1.  The *Payback* [ignores]{.red} the time value of money and the project's cost of capital
2.  It also [ignores]{.red} the cash-flow realizations after the payback period
3.  Finally, it relies on an *ad-hoc* decision around the payback period threshold
...
-   The *payback rule* using the discounted flow then yields:
    ...
    1.  **Year 1**: $\small -219,600+40,514 =$ [-179,085]{.red}
    2.  **Year 2**: $\small -179,085+52,375 =$ [-126,710]{.red}
    3.  **Year 3**: $\small -126,710+52,744 =$ [-73,965]{.red}
    4.  **Year 4**: $\small -73,965+57,914 =$ [-16,050]{.red}
    5.  **Year 5**: $\small -16,050+64,973 =$ [+48,922]{.green}
...
-   *Book Store* has a [higher]{.blue} *IRR*. However, *Coffee Shop* has a higher scale of investment level ($\small \$400,000$ *vs.* $\small \$300,000$), generating a higher *NPV*!
...
1.  Invest $\small \$100$ today, earn $\small\$150$ in one year
2.  Invest $\small$\$100$ today, earn $\small (1.5^5)\times100=759.4$ in $\small 5$ years
...
2.  If now you have a budget constraint of $\small \$100$, how to maximize the gains from the investment?
