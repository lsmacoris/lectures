...
format:
  revealjs:
    title: '10. Firm Valuation and Financial Modeling'
...
-   This lecture aims to walk through a practical application of *Valuation* and *Financial Modeling* using the tools that we have developed thus far in the course to evaluate how much a firm is worth
    ...
    1.  A *Valuation* is nothing more than an assessment of a firm (or project)'s value
        1.  Based on the [current]{.blue} and [past]{.blue} information about the firm, project, and industry, we [estimate]{.blue} its future results and [evaluate]{.blue} how much it is worth in terms of the current period
...
-   You believe a deal could be struck to purchase *Ideko*'s equity at the end of this fiscal year for an [acquisition price of \$150 million]{.blue}, which is almost double *Ideko*'s current book value of equity. Is this price reasonable?
...
$\rightarrow$ *For a more detailed discussion on market-valuation ratios, refer to the [Financial Analysis]{.blue} lecture.*
...
![](Figures/BP.jpg){fig-align="center"}

$\rightarrow$ *You can find the hardcoded numbers in the accompaining Microsoft Excel file*

## Income and Cost Estimates

![](Figures/OP.jpg){fig-align="center"}

$\rightarrow$ *You can find the hardcoded numbers in the accompaining Microsoft Excel file*

1.  The market is expected to grow by 5% per year as the company produces a superior product
2.  KKP plans to cut administrative costs immediately and redirect resources to new product development, sales, and marketing, which will enable increasing market share from 10% to 15% over the next five years

## Capital Expenditures

![](Figures/CAPEX.jpg){fig-align="center"}
...
2.  However, once the growth in volume exceeds 50%, Ideko will definitely need to undertake a major expansion to increase its manufacturing capacity.

## Working Capital Requirements

![](Figures/WC.jpg){fig-align="center"}

$\rightarrow$ *You can find the hardcoded numbers in the accompaining Microsoft Excel file*

1.  Actual Credit Policy: 90 days. The standard for the industry is 60 days, and you believe that Ideko can tighten its credit policy to achieve this goal without sacrificing many sales

2.  While maintaining a certain amount of inventory is necessary to avoid production stoppages, you believe that, with tighter controls of the production process, 30 days' worth of inventory will be adequate

## Planned Debt and Interest Payments

![](Figures/DEBT.jpg){fig-align="center"}
...
![](Figures/USES.jpg){fig-align="center"}

$\rightarrow$ You can find the hardcoded numbers in the accompaining Microsoft Excel file

1.  In addition to the \$150 million purchase price for *Ideko*'s equity, \$4.5 million will be used to repay Ideko's existing debt.
2.  With \$5 million in advisory and other fees associated with the transaction, the acquisition will require \$159.5 million in total funds
3.  Required Equity: $159.5-100-6.5=53,000$
...
![](Figures/PROFORMA.jpg){fig-align="center"}
...
$$ With $NWC_{t}$ defined as *Current Operating Assets* minus *Current Operating Liabilities*
...
![](Figures/WC_PROJ.jpg){fig-align="center"}
...
$\rightarrow$ *For a detailed discussion on Free Cash Flow, refer to the [Fundamentals of Capital Budgeting]{.blue} lecture*.

## Step 4: Forecasting the Free Cash Flow

![](Figures/FCF.jpg){fig-align="center"}
...
-   Because *Ideko* is a [private]{.blue} firm, [we cannot use its own past returns to evaluate its risk]{.blue}, but must instead rely on [comparable publicly traded firms]{.blue}. In this stage, we will use data from the comparable firms identified earlier to estimate a cost of capital for *Ideko*:
...
$$
R_U=R_f + \beta_U\times(E[R_{mkt}-R_f])
